...
If [`search.allow_expensive_queries`]({{site.url}}{{site.baseurl}}/field-types/supported-field-types/wildcard//query-dsl/index/#expensive-queries) is set to `false`, then wildcard queries are not executed.
{: .important}
